...
<body>
<form  name="form1" id="form1" action="miniresult.php" method="get" target="_self" onsubmit="return ss()"  >
<table width="1125"  border="0">
	...
	<tr>
		...
		<td colspan="9" align="center">
			WineName
			<input name="winename" id="winename" style="width:100px; height:20px;" type="text" /> &nbsp;  &nbsp; &nbsp;
			WineryName<input name="wineryname" type="text" style="width:100px; height:20px;" id="wineryname" /> &nbsp; &nbsp; &nbsp;
			<input name="search" type="submit" value="query" style="height:30px;width:70px;" />  
		</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
