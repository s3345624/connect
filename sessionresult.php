...
$arr=array();
$i=0;
global $totalRows_Recordset1,$row_Recordset1,$Recordset1;
echo "winenames:";
do{
...
if (in_array($row_Recordset1['wine_name'],$arr))
	continue;
else
{ $arr[$i++]=$row_Recordset1['wine_name'];
  echo $row_Recordset1['wine_name'].",";
}
...
?>
<a href="http://twitter.com/home?status=<?php wine_name(); ?>" title=" Share your wine names to Twitter" target="_blank" rel="nofollow">Share your wine names to Twitter</a>
...
$totalRows_Recordset1 = mysql_num_rows($Recordset1);
do { ?>
  <?php   if($totalRows_Recordset1==0) echo "no result"; 
  if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
