...
<body>
<form  name="form1" id="form1" action="result.php" method="get" target="_self" onsubmit="return ss()">
<table width="1125"  border="0">
	...
	<tr>
		...
		<td colspan="9" align="center">
			...
			WineryName
			<input name="wineryname" type="text" style="width:100px; height:20px;" id="wineryname" /> &nbsp; &nbsp; &nbsp;
